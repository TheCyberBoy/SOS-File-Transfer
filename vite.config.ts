...
const SITE_URL = process.env.VITE_SITE_URL ?? "https://novosoftlabs.com/";
...
//   standalone-send     one self-contained sos-file-transfer-sender.html
//   standalone-receive  one self-contained sos-file-transfer-receiver.html
//
  ...
  if (standalone) {
    return {
      ...
      plugins: [
        ...
        standaloneCsp(page),
        viteSingleFile(),
        emitAs(outDir, `${page}/index.html`, `sos-file-transfer-${page === "send" ? "sender" : "receiver"}.html`),
      ],
  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: "SOS File Transfer",
          short_name: "SOS Transfer",
          description:
            "Send a file or text between two devices with a screen and a camera. No network. By Novosoft Labs.",
          theme_color: "#060b12",
